...
THE DAY (the day continues as a NEW block SEEDED with this session's
stations — names + tags carry, the Rx recovers, set rows start fresh;
the settled block never reopens — its history stays on its receipt),
delete (two-step, arms by ink — pass 14A).
