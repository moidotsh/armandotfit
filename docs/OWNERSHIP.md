# Vellum — Canonical Doc Ownership
...
|---|---|---|
| Repo operating context (invariants, pre-commit checks, consumer guide, doc maintenance contract) | `CLAUDE.md` | Auto-loads in Claude Code sessions at the vellum root. The "How to consume" section is the load-bearing consumer guide. |
...
| Project orientation (what vellum is, quickstart) | `README.md` | Navigation surface — points at canonical content, doesn't redefine it. |
...
| How to evolve vellum itself (when to fix in vellum vs. in a consumer) | `docs/contributing.md` | — |
