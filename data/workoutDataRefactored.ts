...
export interface Exercise {
  ...
  export const exercises: Record<string, Exercise> = {
    ...
    "overhead-tricep-extension-cable": {"category": "Arms", "name": "Overhead Tricep Extension", "extra": "Cable", "sets": 3, "reps": [8, 10]},
    ...
    "reverse-plus-hammer-curl-superset": {"category": "Arms", "name": "Reverse + Hammer Curl", "extra": "Superset", "sets": 3, "reps": [8, 10]},
    "dumbbell-curl-seated-incline": {"category": "Arms", "name": "Dumbbell Curl", "extra": "Seated Incline", "sets": 3, "reps": [8, 10]},
    "lateral-raise-cable": {"category": "Shoulders", "name": "Lateral Raise", "extra": "Cable", "sets": 3, "reps": [8, 10]},
    "dumbbell-lateral-raise-standing": {"category": "Shoulders", "name": "Dumbbell Lateral Raise", "extra": "Standing", "sets": 3, "reps": [8, 10]},
    "reverse-flyes-cable": {"category": "Shoulders", "name": "Reverse Flyes", "extra": "Cable", "sets": 3, "reps": [12, 15]},
    "face-pull-cable-rope-grip": {"category": "Shoulders", "name": "Face Pull", "extra": "Cable Rope Grip", "sets": 3, "reps": [8, 10]},
    "lower-back-extension-calisthenic": {"category": "Back", "name": "Lower Back Extension", "extra": "Calisthenic", "sets": 3, "reps": [8, 10]},
    ...
    "machine-leg-curl-seated": {"category": "UpperLeg", "name": "Machine Leg Curl", "extra": "Seated", "sets": 3, "reps": [8, 10]},
    "leg-extension-machine": {"category": "UpperLeg", "name": "Leg Extension", "extra": "Machine", "sets": 3, "reps": [8, 10]},
    "hip-adduction-machine": {"category": "UpperLeg", "name": "Hip Adduction", "extra": "Machine", "sets": 3, "reps": [8, 10]},
    "tibia-raise-machine-or-band": {"category": "LowerLeg", "name": "Tibia Raise", "extra": "Machine or Band", "sets": 3, "reps": [8, 10]},
