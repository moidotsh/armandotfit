...
export function RouteCurtain() {
  ...
  // the screen the PWA system bar reads the curtain's ink (near-black,
  // mode-independent); on reveal it returns to the palette's ground.
  // Purely a meta repaint — no visual jank, the OS chrome matches the
  // surface it overlays.
  useEffect(() => {
